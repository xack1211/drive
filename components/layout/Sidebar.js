...
const navigation = [
  { name: 'Local Files', href: '/storage/local', icon: FolderIcon },
  { name: 'Google Drive', href: '/storage/google-drive', icon: CloudIcon },
  { name: 'Dropbox', href: '/storage/dropbox', icon: CloudIcon },
  { name: 'Raspberry Pi', href: '/storage/raspi', icon: ServerIcon },
];
